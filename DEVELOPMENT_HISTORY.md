...
| :--- | :--- | :--- | :--- | :--- |
| 2026-09-07 12:42 | `Local Pending` | Antigravity | **Fix:** Added `ensure_port_free` automatic socket cleanup helper to `start.py` to kill stale processes on ports `8000` & `5173` before spawning Uvicorn & Vite, resolving local launcher socket binding crashes (`[WinError 10048]`). | Completed & Tested |
