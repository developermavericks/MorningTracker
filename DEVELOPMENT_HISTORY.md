...
| 2026-09-17 15:03 | `local` | Mavericks Team | **Historical Job Deletion Controls:** Added `Delete (Keep Scraped Data)` feature allowing users to remove job containers while preserving all scraped articles safely in the database, alongside explicit `Delete Job & Data` complete purging. | Active |
