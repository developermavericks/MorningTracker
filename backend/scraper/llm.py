...
def check_relevance_with_groq_oss(title: str, body: str, keywords: List[str], client_name: str, client_context: Optional[str] = None, use_120b: bool = False) -> tuple[str, str, float]:
    ...
    if client_context:
        ...
        context_str = (
            ...
            "STRICT RELEVANCE & EXCLUSION RULES:\n"
            "- Fintech / Payments / Banking:\n"
            "  * NO stock market updates, routine trading, or market share updates.\n"
            "  * ONLY include fintech/banking news if it contains a brand IPO announcement.\n"
            "- UPI / RuPay:\n"
            "  * ONLY include RBI changes or new regulations.\n"
            "  * ONLY include major feature upgrades by brands.\n"
            "  * Exclude EPFO-related updates.\n"
            "  * Avoid small or routine/minor updates related to UPI or RuPay.\n"
            "- Appointments / Leadership:\n"
            "  * DO NOT include regular appointment, hiring, or human resources news.\n"
            "  * ONLY include if a major leader or co-founder exits.\n"
            "  * ONLY include if the news is widely significant to the industry.\n"
            "- Hospitality / Hotels:\n"
            "  * Avoid Tier C/Category C coverage with unknown/obscure locations.\n"
            "  * Avoid small or low-relevance hotel launches.\n"
            "  * For new hotels: ONLY include major hotel brands expanding, or expansion into new cities or markets. Avoid small property launches.\n"
            "- Tourism:\n"
            "  * Exclude generic tourism news, tourist footfalls, or seasonal trends (e.g. 'Srinagar tulip garden sees high tourist footfall' must be REJECTED).\n"
            "  * Exclude medical wellness-related news, museums, or exhibitions.\n"
            "  * Avoid global tourism news unless specifically shared by client or team.\n"
            "- Airlines:\n"
            "  * ONLY include new flights or new routes/city/country connectivity.\n"
            "  * DO NOT include fuel cost news or internal airline operational updates.\n"
            "- Railways & Routes:\n"
            "  * ONLY include new train launches or new route launches.\n"
            "  * DO NOT include minor feature upgrades in trains (e.g. 'Indian Railways introduces new sleeper berth features' must be REJECTED).\n"
            "- Visa:\n"
            "  * DO NOT include visa rejections or routine visa updates.\n"
